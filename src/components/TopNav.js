...
export default function TopNav() {
  ...
  return (
    <div
      className="max-w-[1510px] mx-auto flex justify-between
     items-center p-4"
    >
      <div className="flex items-center">
        <div onClick={openSideHandler} className="cursor-pointer">
      ...
      <div
        className={
          sideNav
            ...
            : "fixed top-0 left-[-1000px] w-[300px] h-screen bg-white z-10 duration-500"
        }
      >
        <AiOutlineClose
          size={25}
        ...
        <h2 className="text-2xl p-4 ">
          Yummy<span className="text-orange-700 font-bold">Eats</span>
        </h2>
        <nav>
